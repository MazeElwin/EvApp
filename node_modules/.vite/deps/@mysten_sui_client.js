...
var MvrClient = class {
  constructor({ cache, url, pageSize = 50, overrides }) {
    __privateAdd6(this, _MvrClient_instances);
    __privateAdd6(this, _cache2);
    __privateAdd6(this, _url);
    __privateAdd6(this, _pageSize);
    __privateAdd6(this, _overrides);
...
mvrPackageDataLoader_get = function() {
  return __privateGet5(this, _cache2).readSync(["#mvrPackageDataLoader", __privateGet5(this, _url) ?? ""], () => {
    ...
    const loader = new DataLoader(async (packages) => {
      ...
      const resolved = await __privateMethod4(this, _MvrClient_instances, resolvePackages_fn).call(this, packages);
      return packages.map(
...
mvrTypeDataLoader_get = function() {
  return __privateGet5(this, _cache2).readSync(["#mvrTypeDataLoader", __privateGet5(this, _url) ?? ""], () => {
    ...
    const loader = new DataLoader(async (types) => {
      ...
      const resolved = await __privateMethod4(this, _MvrClient_instances, resolveTypes_fn).call(this, types);
...
resolvePackages_fn = async function(packages) {
  ...
  await Promise.all(
    batches.map(async (batch) => {
      var _a;
      const data = await __privateMethod4(this, _MvrClient_instances, fetch_fn).call(this, "/v1/resolution/bulk", {
        names: batch
      });
...
resolveTypes_fn = async function(types) {
  ...
  await Promise.all(
    batches.map(async (batch) => {
      var _a;
      const data = await __privateMethod4(this, _MvrClient_instances, fetch_fn).call(this, "/v1/struct-definition/bulk", {
        types: batch
      });
      if (!(data == null ? void 0 : data.resolution)) return;
...
var _Transaction = class _Transaction2 {
  constructor() {
    __privateAdd7(this, _Transaction_instances);
    __privateAdd7(this, _serializationPlugins);
    __privateAdd7(this, _buildPlugins);
    __privateAdd7(this, _intentResolvers, /* @__PURE__ */ new Map());
    __privateAdd7(this, _inputSection, []);
    __privateAdd7(this, _commandSection, []);
    __privateAdd7(this, _availableResults, /* @__PURE__ */ new Set());
    __privateAdd7(this, _pendingPromises, /* @__PURE__ */ new Set());
    __privateAdd7(this, _added, /* @__PURE__ */ new Map());
    ...
    this.object = createObjectMethods(
      (value) => {
        ...
        return inserted ? { $kind: "Input", Input: __privateGet6(this, _data).inputs.indexOf(inserted), type: "object" } : __privateMethod5(this, _Transaction_instances, addInput_fn).call(this, "object", typeof value === "string" ? {
          $kind: "UnresolvedObject",
    ...
    Object.defineProperty(this, "pure", {
      ...
      value: createPure((value) => {
        if (isSerializedBcs(value)) {
          return __privateMethod5(this, _Transaction_instances, addInput_fn).call(this, "pure", {
            $kind: "Pure",
            Pure: {
        ...
        return __privateMethod5(this, _Transaction_instances, addInput_fn).call(this, "pure", is(NormalizedCallArg, value) ? parse(NormalizedCallArg, value) : value instanceof Uint8Array ? Inputs.Pure(value) : { $kind: "UnresolvedPure", UnresolvedPure: { value } });
      })
    });
    return this.pure;
  }
  ...
  add(command) {
    if (typeof command === "function") {
      ...
      const fork = __privateMethod5(this, _Transaction_instances, fork_fn).call(this);
      ...
      const placeholder = __privateMethod5(this, _Transaction_instances, addCommand_fn).call(this, {
        $kind: "$Intent",
        $Intent: {
      ...
      __privateMethod5(this, _Transaction_instances, addCommand_fn).call(this, command);
    }
  ...
  splitCoins(coin, amounts) {
    const command = Commands.SplitCoins(
      typeof coin === "string" ? this.object(coin) : __privateMethod5(this, _Transaction_instances, resolveArgument_fn).call(this, coin),
      amounts.map(
        (amount) => typeof amount === "number" || typeof amount === "bigint" || typeof amount === "string" ? this.pure.u64(amount) : __privateMethod5(this, _Transaction_instances, normalizeTransactionArgument_fn).call(this, amount)
      )
    );
    __privateMethod5(this, _Transaction_instances, addCommand_fn).call(this, command);
  ...
  moveCall({
    ...
    return this.add(
      Commands.MoveCall({
        ...input,
        arguments: args == null ? void 0 : args.map((arg) => __privateMethod5(this, _Transaction_instances, normalizeTransactionArgument_fn).call(this, arg))
      })
    );
  }
  transferObjects(objects, address) {
    return this.add(
      Commands.TransferObjects(
        ...
        typeof address === "string" ? this.pure.address(address) : __privateMethod5(this, _Transaction_instances, normalizeTransactionArgument_fn).call(this, address)
      )
    );
  }
  makeMoveVec({
  ...
  async build(options = {}) {
    await this.prepareForSerialization(options);
    await __privateMethod5(this, _Transaction_instances, prepareBuild_fn).call(this, options);
  ...
  async prepareForSerialization(options) {
    var _a;
    await __privateMethod5(this, _Transaction_instances, waitForPendingTasks_fn).call(this);
    __privateMethod5(this, _Transaction_instances, sortCommandsAndInputs_fn).call(this);
    ...
    await __privateMethod5(this, _Transaction_instances, runPlugins_fn).call(this, steps, options);
  }
};
...
normalizeTransactionArgument_fn = function(arg) {
  ...
  return __privateMethod5(this, _Transaction_instances, resolveArgument_fn).call(this, arg);
};
resolveArgument_fn = function(arg) {
  if (typeof arg === "function") {
    const resolved = this.add(arg);
    if (typeof resolved === "function") {
      return __privateMethod5(this, _Transaction_instances, resolveArgument_fn).call(this, resolved);
    }
...
prepareBuild_fn = async function(options) {
  ...
  await __privateMethod5(this, _Transaction_instances, runPlugins_fn).call(this, [...__privateGet6(this, _buildPlugins), resolveTransactionPlugin], options);
};
...
var JSONRpcCoreClient = class extends Experimental_CoreClient {
  constructor({
    ...
    __privateAdd8(this, _jsonRpcClient);
